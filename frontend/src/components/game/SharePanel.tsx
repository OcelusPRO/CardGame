...
/**
 * The invitation. Code and QR stay out of sight until asked for, because a lobby is often
 * on a screen other people can see.
 *
 * The block keeps its footprint whether it shows or not: hiding it with `visibility`
 * rather than unmounting it means the panel never jumps when the button is pressed.
 */
    ...
    <Panel>
      <div className="flex flex-col items-center gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="text-center sm:text-left">
          <p className="text-xs font-semibold uppercase tracking-wider text-white/50">Inviter du monde</p>
        ...
        >
          <p className="font-display text-4xl font-extrabold tracking-[0.2em] text-zap">{code}</p>
