...
fun Route.authRoutes(
    ...
    twitch: TwitchConfig,
    extension: TwitchExtensionConfig,
    hostTokens: TwitchHostTokens,
) {
    ...
    get("/api/me") {
        ...
        call.respond(
            MeView(
                ...
                twitchExtensionAvailable = extension.enabled,
                twitchRewardsAuthorized = hostTokens.holds(player.twitchId),
            )
        )
    }
